...
- Create Angular project with ng: `ng new aspangularapp1.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`aspangularapp1.client.esproj`).
